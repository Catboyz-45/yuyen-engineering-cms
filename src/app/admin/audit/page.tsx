/**
 * หน้าที่ของไฟล์นี้: หน้าเว็บเส้นทาง /admin/audit แสดงประวัติการทำงานทั้งหมดสำหรับ Super Admin พร้อมค้นหาและแบ่งหน้า
 *
...
/** สร้างส่วนหน้าจอ AuditPage; รับข้อมูลผ่านพารามิเตอร์แล้วคืน React elements สำหรับแสดงผล */
