...
export function Logo({ inverse = false, media }: Readonly<{ inverse?: boolean; media?: { id: string } | null }>) {
  return (
    <span className="brand">
      {/* โลโก้จาก CMS มาก่อน ถ้ายังไม่อัปโหลดใช้โลโก้บริษัทจากหัวจดหมาย; ชื่อบริษัทข้างๆ ทำหน้าที่เป็นข้อความแทนรูปอยู่แล้ว */}
      {media
        ...
        // eslint-disable-next-line @next/next/no-img-element -- a 160px static asset needs no resizing
        : <img className="brand-logo brand-logo-default" src={brandLogo.src} alt="" width={40} height={40} />}
